...
4. Важливо: посилання на оригінал новини (URL) має бути вшито безпосередньо в заголовок через тег <a href="URL">...</a>. Не виводь сирі URL-адреси окремим текстом.
...
6. Допускаються Тільки дозволені HTML-теги: <b>, <i>, <a>. Усі теги мають бути правильно закриті. Не використовуй непідтримувані Телеграмом теги.
